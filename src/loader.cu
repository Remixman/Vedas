...
static TYPEID_HOST_VEC *s_p, *p_p, *o_p;
static DICTTYPE *so_map_p, *p_map_p, *l_map_p;
static REVERSE_DICTTYPE *r_so_map_p, *r_p_map_p, *r_l_map_p;
static TYPEID so_count = 1, p_count = 1, l_count = LITERAL_START_ID;
static bool enable_literal_dict = false;
...
void load_rdf(const char *f, TYPEID_HOST_VEC &s, TYPEID_HOST_VEC &p, TYPEID_HOST_VEC &o,
               ...
               REVERSE_DICTTYPE &r_so_map, REVERSE_DICTTYPE &r_p_map, REVERSE_DICTTYPE &r_l_map, bool enable_ldict) {
    s_p = &s;
    p_p = &p;
    o_p = &o;
    so_map_p = &so_map;
    ...
    enable_literal_dict = enable_ldict;
...
void load_test_rdf(TYPEID_HOST_VEC &s, TYPEID_HOST_VEC &p, TYPEID_HOST_VEC &o,
